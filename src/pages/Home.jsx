                ...
                <div className="nav-header">
                    <a href="index.html" className="brand-logo">
                        ...
                        <svg className="brand-title" width="124px" height="33px">
                            <path className="svg-title-path" fillRule="evenodd" fill="rgb(25, 59, 98)"
                            ...
                            <div className="collapse navbar-collapse justify-content-between">
                                ...
                                <ul className="navbar-nav header-right">
                                    ...
                                    <li className="nav-item dropdown notification_dropdown">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end">
                                            <div id="dlab_W_Notification1" className="widget-media dlab-scroll p-3" style={{ height: '380px' }}>
                                                <ul className="timeline">
                                                    <li>
                        ...
                        <ul className="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li>
                                        <a className="has-arrow" href="javascript:void(0)" aria-expanded="false">Email</a>
                                        <ul aria-expanded="false">
                                    ...
                                    <li>
                                        <a className="has-arrow" href="javascript:void(0)" aria-expanded="false">Shop</a>
                                        <ul aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li><a href="./uc-file-upload.html">File Upload</a></li>
                                    <li><a href="./uc-jquery-ui.html">Jquery UI</a></li>
                                    <li><a href="./uc-lightgallery.html">Light Gallery</a></li>
                                    <li><a href="./uc-clipboard.html">Clipboard</a></li>
                                    <li><a href="./uc-maps.html">Maps</a></li>
                                </ul>
                            </li>
                            <li>
                                <a className="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                ...
                <div className="dlabnav">
                    <div className="dlabnav-scroll">
                        <ul className="metismenu" id="menu">
                            ...
                            {/* Continue with the rest of the menu items similarly... */}
                        </ul>
                    </div>
                </div>
